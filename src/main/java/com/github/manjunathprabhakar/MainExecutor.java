...
import com.github.manjunathprabhakar.constants.DataFields;
import com.github.manjunathprabhakar.elk.ELKservice;
import com.github.manjunathprabhakar.elk.ESCredentials;
import com.github.manjunathprabhakar.pojos.out.StashOutPojos;
import com.github.manjunathprabhakar.pojos.inparser.*;
...
public class MainExecutor {
    public static void main(String[] args) throws Exception {
        ...
        //TEST DATA JSONS
        List<FeaturePOJO> jsons = ReportHandler.getJSONsToList("json");
        ...
        for (FeaturePOJO featurePOJO : featurePOJOS) {
            ...
            for (Elements element : featurePOJO.getElements()) {
               ...
               // System.out.println(element.getKeyword() + "=>" + featurePOJO.getUri() + " => " + featurePOJO.getName() + " => " + element.getName() + " => " + element.getStatus());
        ...
        for (StashOutPojos result : results) {
            ...
            new ELKservice().sendToElastic(creds, result);
        }
